...
urlpatterns = [
    ...
    path('reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name='templates/password/password_reset_complete.html'), name='password_reset_complete'),      
]